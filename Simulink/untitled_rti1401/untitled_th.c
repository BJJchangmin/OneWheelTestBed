/************************ dSPACE target specific file *************************
   ...
   Include file .\untitled_rti1401\untitled_th.c :

   Task Configuration file for model : untitled

   RTI1401 7.9 (02-Nov-2017)/2.17
   17-Mar-2025 15:34:04
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\untitled_rti1401\untitled_th.c is for ST).
# endif
